                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="sdt" required value="{{ old('sdt', $user->dien_thoai ?? '') }}">
                        </div>
                        <div class="mb-3">
                            <label for="diachi" class="form-label">Địa chỉ nhận hàng</label>
                            <input type="text" class="form-control" name="diachi" required value="{{ old('diachi', $user->dia_chi ?? '') }}">
                        </div>
                        <div class="mb-3">
                        ...
                        @forelse($carts as $cart)
                            @foreach($cart->items as $item)
                                <div class="d-flex justify-content-between align-items-start border-bottom py-2">
                                    <div>
                                        <strong>{{ $item->variant->product->ten_san_pham ?? '' }}</strong><br>
